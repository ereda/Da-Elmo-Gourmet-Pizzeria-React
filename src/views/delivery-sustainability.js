...
.hero-parallax-bg {
  transform: scale(1);
      ...
      <section className="wine-pairing-section">
        <div className="wine-pairing-background">
          <video
            src="https://videos.pexels.com/video-files/6624927/6624927-hd_720_1280_60fps.mp4"
            loop="true"
            muted="true"
            autoPlay="true"
            playsInline="true"
            className="wine-pairing-video"
          ></video>
          <div className="wine-pairing-overlay"></div>
        </div>
        <div className="wine-pairing-content-wrapper">
          <div className="wine-pairing-card">
            ...
            <p className="section-subtitle">
              Curated Wine &amp; Flavor Pairings
            </p>
            <div className="wine-pairing-description">
              <p className="section-content">
                {' '}
                Each of our six signature pizzas comes with expert wine pairing
                suggestions designed to enhance your at-home dining experience.
                From the rich, fruity notes of a Barbera with our Pepperoni
                Rustico to the crisp acidity of a Chianti Classico complementing
                the Pizza Tricolore, every recommendation is carefully crafted
                to elevate the flavors you love.
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
                  }}
            ...
            <div className="wine-pairing-features">
              <div className="wine-pairing-feature">
                <svg
                  width="28"
                  xmlns="http://www.w3.org/2000/svg"
                  height="28"
