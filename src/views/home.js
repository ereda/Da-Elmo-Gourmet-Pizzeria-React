...
const Home = (props) => {
  return (
    <div className="home-container1">
      ...
      <section className="services-wine">
        <div className="services-wine-wrapper">
          <div className="services-wine-container">
            <div className="services-wine-header">
              <div className="services-wine-icon">
                <svg
                  width="48"
                  xmlns="http://www.w3.org/2000/svg"
                  height="48"
              ...
              <p className="section-subtitle">
                {' '}
                Elevate your gourmet pizza experience with expertly curated wine
                pairings that complement each pizza&apos;s unique flavor
                profile.
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
            ...
            <div className="services-wine-list">
              <div className="services-wine-item">
                <div className="services-wine-item-number">
                  <span>01</span>
                </div>
                <div className="services-wine-item-content">
                  <h3 className="services-wine-item-title">Pizza Tricolore</h3>
                  <p className="services-wine-item-description">
                    {' '}
                    The high acidity of a Chianti Classico (made from
                    Sangiovese) perfectly matches the acidity of the San Marzano
                    tomatoes. A crisp Pinot Grigio is a light white option that
                    won&apos;t overpower the delicate flavors of fresh
                  ...
                  <div className="services-wine-item-tags">
                    <span className="services-wine-item-tag">
                      Chianti Classico
                    </span>
                    <span className="services-wine-item-tag">Pinot Grigio</span>
                  </div>
                </div>
              </div>
              <div className="services-wine-item">
                ...
                <div className="services-wine-item-content">
                  <h3 className="services-wine-item-title">
                    Pepperoni Rustico
                  </h3>
                  <p className="services-wine-item-description">
                    {' '}
                    Pairs perfectly with Barbera, considered the quintessential
                    &quot;pizza wine&quot; because its high acidity cuts through
                    the richness. A rich, fruity Zinfandel is another excellent
                    choice that holds up to the bold, spicy flavor of pepperoni
                    and hot honey.
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                  ...
                  <div className="services-wine-item-tags">
                    <span className="services-wine-item-tag">Barbera</span>
                    <span className="services-wine-item-tag">Zinfandel</span>
                  </div>
                </div>
              </div>
              <div className="services-wine-item">
                ...
                <div className="services-wine-item-content">
                  <h3 className="services-wine-item-title">Verde Fresco</h3>
                  <p className="services-wine-item-description">
                    {' '}
                    Pairs well with a crisp, unoaked Chardonnay that complements
                    the creamy mozzarella and aromatic herbs without
                    overpowering them. Alternatively, a light-bodied Pinot Noir
                    has enough acidity to balance the garlic and oil while
                    enhancing the arugula.
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                      }}
              ...
              <div className="services-wine-item">
                ...
                <div className="services-wine-item-content">
                  ...
                  <p className="services-wine-item-description">
                    ...
                    cleanse. The citrusy notes cut through the saltiness of feta
                    and olives beautifully.
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                      }}
              ...
              <div className="services-wine-item">
                ...
                <div className="services-wine-item-content">
                  <h3 className="services-wine-item-title">Tuscan Gardener</h3>
                  <p className="services-wine-item-description">
                    {' '}
                    Pairs beautifully with the bright acidity and herbaceous
                    notes of a Sauvignon Blanc or a lighter, earthy Pinot Noir.
                    Both options complement the variety of roasted vegetables
                    and mushrooms without overwhelming the delicate flavors.
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                      }}
              ...
              <div className="services-wine-item">
                ...
                <div className="services-wine-item-content">
                  <h3 className="services-wine-item-title">Funghi e Cipolla</h3>
                  <p className="services-wine-item-description">
                    {' '}
                    Pairs beautifully with the subtle, earthy complexity of a
                    Pinot Noir or the savory, herbaceous notes of a Cabernet
                    Franc. Both wines enhance the umami-rich mushrooms and
                    complement the peppery radish microgreens and basil finish.
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                      }}
                  ...
                  <div className="services-wine-item-tags">
                    <span className="services-wine-item-tag">Pinot Noir</span>
                    <span className="services-wine-item-tag">
                      Cabernet Franc
                    </span>
                  </div>
